        ...
        for task in tasks:
            ...
            if 'deadline' in task:
                try:
                    ...
                    logger.warning("Skipping deadline check for task with unparseable deadline: %s",
                                    task.get('id'))
            ...
            if 'last_update' in task:
                try:
                    ...
                    logger.warning("Skipping staleness check for task with unparseable last_update: %s",
                                    task.get('id'))
